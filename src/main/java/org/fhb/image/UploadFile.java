...
public class UploadFile {
	private  String bucketName = "newimg1";
	private static String keyName = "sample";
	private static String uploadFileName = "C:/Users/Ali/aws.txt";
   //Constr was ist die Name die BucketName
	public UploadFile(String bucketName) {
		this.bucketName=bucketName;
	}

	void uploadfile(AWSCredentials credentials, File image) {
